...
*Eis aqui meu projeto e sua respectiva documentação referente à área de Product Owner (PO) em meu processo seletivo (PS) de trainee da Empresa Júnior (EJ) E-makers.*
...
Por fim, o software CorrijaMe+, com funcionalidades para cada um dos três perfis de usuários que usufruirão do sistema de correções: Aluno, Corretor e 
Administrador, foi estruturado em torno de 28 telas, cujas quais são:
